...
public class TeacherRegisterController {
    ...
    public void register() {
        ...
        if (validateFields(username, name, gender, age, position, department, password, confirmPassword)) {
...
//            Database.storeTeacherCredentials(username, name, gender, age, position, department, password);
    ...
    private boolean validateFields(String username, String name, String gender, String age, String position, String department, String password, String confirmPassword) {
